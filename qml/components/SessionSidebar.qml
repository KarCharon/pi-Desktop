    ...
    ColumnLayout {
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                color: entry.isFolder && entry.selected ? "#e7e2d8"
                     : entry.isSession && entry.selected ? "#e9e4da"
                     : entryMouse.containsMouse ? "#ebe7df"
                     : entry.modelData.kind === "project" ? "#ece7dd"
                     : "transparent"
                ...
                Rectangle {
                    ...
                    color: entry.isFolder ? "#dcd6c9" : "#e4dfd3"
                }
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Label {
                            ...
                            color: entry.isSession ? (entry.selected ? "#2f2c28" : "#403d37")
                                 : entry.isFolder ? "#6a5f50" : "#463d33"
                            font.pixelSize: 12
                        ...
                        Label {
                            ...
                            color: entry.isFolder ? "#9c958b" : "#9a948a"
                            font.pixelSize: 10
